...
Exit Sub
er:
Call MsgBox("Une erreur d'initialisation du logiciel c'est produite(Num�ros de l'erreur : " & Err.Number & " Description : " & Err.description & " Source : " & Err.Source & "). Si le probl�me p�rsiste veulliez contacter un administrateur.", vbCritical, "Erreur")
Call GameDestroy
End Sub
...
Next y
    ...
    If Not deco Then
        ...
        If IsConnected = False Then Call MsgBox("Merci d'avoir jou� � " & GAME_NAME & "!", vbOKOnly, GAME_NAME)
    Else
        deco = False
        Call MsgBox("Merci d'avoirs jou� � " & GAME_NAME & "!", vbOKOnly, GAME_NAME)
    End If
Exit Sub
er:
